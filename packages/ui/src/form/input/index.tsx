  ...
  return (
    <>
      <div className={`relative w-full min-w-0 ${sizes[size]}`}>
        <input
          className={` border-blue-gray-200 text-blue-gray-700 disabled:bg-blue-gray-50 bg-default caret-secondary peer h-full w-full rounded-md border !border-t-0 px-3 py-2.5 font-sans text-sm font-normal outline-0 transition-colors duration-200 placeholder-shown:!border-t  focus:border-2 focus:border-t-transparent focus:outline-0 focus-visible:outline-none focus-visible:outline-0 disabled:border-0 ${
            error
        ...
        />
        <label
          className={`before:content[' '] after:content[' '] text-blue-gray-400 before:border-blue-gray-200 after:border-blue-gray-200 peer-placeholder-shown:text-blue-gray-500 peer-autofill:text-blue-gray-500 peer-disabled:peer-placeholder-shown:text-blue-gray-500 peer-focus:text-secondary-500 peer-focus:before:border-secondary-500 peer-focus:after:border-secondary-500 pointer-events-none absolute -top-1.5 left-0 flex h-full w-full select-none text-[11px] font-normal leading-tight transition-all duration-200 before:pointer-events-none before:mr-1 before:mt-[6px] before:box-border before:block before:h-1.5 before:w-2.5 before:rounded-tl-md before:border-l before:border-t before:transition-all before:duration-200 after:pointer-events-none after:ml-1 after:mt-[6px] after:box-border after:block after:h-1.5 after:w-2.5 after:flex-grow after:rounded-tr-md after:border-r after:border-t
          after:transition-all after:duration-200 peer-placeholder-shown:text-sm peer-placeholder-shown:before:border-transparent
